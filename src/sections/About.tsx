...
import { sectionCardVariants, sectionContainerVariants, viewportReveal } from "@/components/animation-presets";
...
export const AboutSection = () => {
  ...
  return <div className="py-20 lg:py-28" id="about">
    <div className="container">
      ...
      />
      <motion.div className="mt-20 flex flex-col gap-8" initial="hidden" whileInView="visible" viewport={viewportReveal} variants={sectionContainerVariants}>
        <div className="flex flex-col gap-8 md:grid md:grid-cols-5 lg:grid-cols-3">
          <MotionCard className="h-[320px] md:col-span-2 lg:col-span-1" variants={sectionCardVariants}>
          ...
          {/* card 2 */}
          <MotionCard className="h-[320px] md:col-span-3 lg:col-span-2" variants={sectionCardVariants} transition={{ delay: 0.08 }}>
              <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-3 gap-8">
          <MotionCard className="h-[320px] p-0 flex flex-col md:col-span-3 lg:col-span-2" variants={sectionCardVariants} transition={{ delay: 0.16 }}>
              <div>
              ...
              <div className="relative flex-1" ref={constraintRef}>
                {hobbies.map((hobby, index) => (
                  <motion.div key={hobby.title} initial={{ opacity: 0, y: 14, scale: 0.96 }} whileInView={{ opacity: 1, y: 0, scale: 1 }} viewport={viewportReveal} transition={{ duration: 0.55, delay: index * 0.05 }} className="inline-flex items-center absolute gap-2 px-6 bg-gradient-to-r from-emerald-300 to-sky-400 rounded-full py-1.5"
                    style={{
                      left: hobby.left,
                      top: hobby.top
          ...
          <MotionCard className="h-[320px] p-0 md:col-span-2 lg:col-span-1 relative" variants={sectionCardVariants} transition={{ delay: 0.24 }}>
